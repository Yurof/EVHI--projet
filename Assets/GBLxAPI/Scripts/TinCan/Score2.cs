...
namespace TinCan
{
    public class Score2 : JsonModel
    {
        ...
        public Score2(StringOfJSON json) : this(json.toJObject()) { }

        public Score2(JObject jobj)
        {
            if (jobj["scaled"] != null)
            {
        ...
        public static explicit operator Score2(JObject jobj)
        {
            return new Score2(jobj);
        }
    }
}

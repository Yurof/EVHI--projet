...
namespace DIG.GBLXAPI.Builders
{
    ...
    {
        public static ResultBuilder Start()
        ...
        public ResultBuilder Complete()
        { return WithCompletion(true); }

        public ResultBuilder Incomplete()
        { return WithCompletion(false); }
        ...
        public ResultBuilder Successful()
        ...
        {
            _result.score = new Score2 { raw = score };
